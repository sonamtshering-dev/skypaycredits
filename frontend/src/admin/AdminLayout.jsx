  ...
  const SidebarContent = () => (
    <>
      ...
      <div style={{ padding: '12px 10px', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <NavLink to="/" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 12px', borderRadius: 10, fontSize: 13, color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: 4 }}><ArrowLeft size={13} /> View Site</NavLink>
